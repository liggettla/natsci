...
Using TOPMed whole genome sequencing to measure CHIP, it appears that
CHIP is associated with different inflammatory traits, and that
TERT/TET2 SNPs predispose to CHIP \citep{Bick2019-ji}.
