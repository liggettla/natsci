...
\citep{grinfeld2018classification} While the identities of driver
mutations can predict disease phenotype and prognosis
...
dominate the hematopoietic system in a similar manner to CHIP. It is
interesting to note that the mutation order can influence the type of
MPN \citep{ortmann2015effect, nangalia2015dnmt3a}.
